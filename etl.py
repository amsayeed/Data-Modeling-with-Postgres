...
def process_song_file(cur, filepath):
    """
    Description: This function is responsible for Process and load data from one song file to the database
...
def process_log_file(cur, filepath):
    """
    Description: This function is responsible for Process and load data from one log file and save it to the database
